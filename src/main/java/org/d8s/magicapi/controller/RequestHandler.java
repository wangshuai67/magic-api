...
import org.d8s.magicapi.context.CookieContext;
import org.d8s.magicapi.context.RequestContext;
import org.d8s.magicapi.context.SessionContext;
import org.d8s.magicapi.interceptor.RequestInterceptor;
import org.d8s.magicapi.logging.LogInfo;
import org.d8s.magicapi.logging.MagicLoggerContext;
import org.d8s.magicapi.model.*;
...
import org.d8s.magicapi.model.*;
import org.d8s.magicapi.modules.ResponseModule;
import org.d8s.magicapi.provider.ResultProvider;
import org.d8s.magicapi.script.ScriptManager;
import org.d8s.magicapi.utils.PatternUtils;
import org.d8s.script.MagicScriptContext;
import org.d8s.script.MagicScriptDebugContext;
...
import org.d8s.script.reflection.JavaInvoker;
...
import static org.d8s.magicapi.model.Constants.*;
